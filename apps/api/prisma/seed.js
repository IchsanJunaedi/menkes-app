...
async function main() {
    ...
    const kemenkes = await prisma.organization.create({
        data: {
            ...
            type: client_1.OrganizationType.HOSPITAL, // Usually Ministry, using HOSPITAL as placeholder
    ...
    const encounter = await prisma.encounter.create({
        data: {
            ...
            organizationId: rscm.id,
            status: client_1.EncounterStatus.FINISHED,
            class: client_1.EncounterClass.AMBULATORY,
